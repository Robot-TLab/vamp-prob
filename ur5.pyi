...
def upper_bounds() -> Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')]: ...

def lower_bounds() -> Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')]: ...
...
class RNG:
    ...
    def next(self) -> Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')]:
...
class ProlateHyperspheroid:
    ...
    def __init__(self, arg0: Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')], arg1: Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')], /) -> None:
        """Construct from two loci."""

    def set_transverse_diameter(self, arg: float, /) -> None: ...

    def transform(self, arg: "vamp::Vector<vamp::SIMDVector<float __vector(8)>, 1ul, 6ul>", /) -> "vamp::Vector<vamp::SIMDVector<float __vector(8)>, 1ul, 6ul>": ...
...
class Path:
    ...
    def __getitem__(self, arg: int, /) -> Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')]:
        """Get the i-th configuration in the path."""

    @overload
    def __setitem__(self, arg0: int, arg1: Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')], /) -> None:
    ...
    @overload
    def append(self, arg: Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')], /) -> None:
    ...
    @overload
    def insert(self, arg0: int, arg1: Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')], /) -> None:
        """Append a configuration to the end of this path."""
...
class Roadmap:
    ...
    @property
    def vertices(self) -> list["vamp::Vector<vamp::SIMDVector<float __vector(8)>, 1ul, 6ul>"]:
...
@overload
def fk(configuration: Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')]) -> list[_core_ext.Sphere]:
    """
...
@overload
def eefk(configuration: Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')]) -> Annotated[ArrayLike, dict(dtype='float32', shape=(4, 4), order='F')]:
    """
...
@overload
def debug(configuration: Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')], environment: _core_ext.Environment = ...) -> tuple[list[list[str]], list[tuple[int, int]]]:
...
@overload
def validate(configuration: Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')], environment: _core_ext.Environment = ..., check_bounds: bool = False) -> bool:
...
@overload
def validate_motion(configuration_in: Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')], configuration_out: Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')], environment: _core_ext.Environment = ..., check_bounds: bool = True) -> bool:
    """Check if a configuration is valid. Returns true if valid."""
...
@overload
def filter_self_from_pointcloud(pc: Sequence[Sequence[float]], point_radius: float, configuration: Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')], environment: _core_ext.Environment = ...) -> list[list[float]]:
    """
...
@overload
def roadmap(start: Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')], goal: Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')], environment: _core_ext.Environment, settings: _core_ext.PRMSettings, rng: RNG) -> Roadmap:
...
@overload
def rrtc(start: Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')], goal: Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')], environment: _core_ext.Environment, settings: _core_ext.RRTCSettings, rng: RNG) -> PlanningResult:
    """RRTConnect"""
...
@overload
def rrtc(start: Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')], goal: Sequence[Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')]], environment: _core_ext.Environment, settings: _core_ext.RRTCSettings, rng: RNG) -> PlanningResult: ...
...
@overload
def prm(start: Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')], goal: Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')], environment: _core_ext.Environment, settings: _core_ext.PRMSettings, rng: RNG) -> PlanningResult:
    """PRM"""
...
@overload
def prm(start: Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')], goal: Sequence[Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')]], environment: _core_ext.Environment, settings: _core_ext.PRMSettings, rng: RNG) -> PlanningResult: ...
...
@overload
def fcit(start: Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')], goal: Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')], environment: _core_ext.Environment, settings: _core_ext.FCITSettings, rng: RNG) -> PlanningResult:
    """FCIT"""
...
@overload
def fcit(start: Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')], goal: Sequence[Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')]], environment: _core_ext.Environment, settings: _core_ext.FCITSettings, rng: RNG) -> PlanningResult: ...
...
@overload
def aorrtc(start: Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')], goal: Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')], environment: _core_ext.Environment, settings: _core_ext.AORRTCSettings, rng: RNG) -> PlanningResult:
    """AORRTC"""
...
@overload
def aorrtc(start: Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')], goal: Sequence[Annotated[ArrayLike, dict(dtype='float32', shape=(6), device='cpu')]], environment: _core_ext.Environment, settings: _core_ext.AORRTCSettings, rng: RNG) -> PlanningResult: ...
